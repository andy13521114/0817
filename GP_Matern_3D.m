...
%[log_like_post]  = log_like_Step2c_0208_EXT(reshape_t,nan_ind,y.X,y.Y,y.z,sof_v,sof_h,nu_v,nu_h,bhp,alpha,y,Cs,ahp,sof_v_t,sof_h_t);
[log_like_post]  = log_like_Step2c(reshape_t,nan_ind,y.X,y.Y,y.z,sof_v,sof_h,nu_v,nu_h,bhp,alpha,y,Cs);
